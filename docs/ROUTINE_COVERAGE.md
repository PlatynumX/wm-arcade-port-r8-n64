...
|---|---|---|
| `implemented` | a port identifier IS the name, ends with it, or is a generator's wrapper around it | 2036 |
...
**2605 of 2607 routines are accounted for; 2 are open** (`cited` + `unknown`).
