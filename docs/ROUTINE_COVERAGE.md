...
|---|---|---|
| `implemented` | a port identifier IS the name, ends with it, or is a generator's wrapper around it | 2029 |
...
| `unknown` | no mention anywhere | 6 |

**2598 of 2607 routines are accounted for; 9 are open** (`cited` + `unknown`).
...
| WRESTLE.ASM | 2 | `auto_pin_check`, `shake_all_ropes` |
