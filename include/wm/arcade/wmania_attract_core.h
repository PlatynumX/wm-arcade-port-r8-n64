...
typedef enum {
    WM_ATTRACT_HISCORES = 0,
    WM_ATTRACT_DCS_LOGO,
    WM_ATTRACT_SPORTS_LOGO,
    WM_ATTRACT_GAMEPLAY_DEMO_1,
    WM_ATTRACT_CREDITS_1,
    WM_ATTRACT_TITLE,
    WM_ATTRACT_GAMEPLAY_DEMO_2,
    WM_ATTRACT_CREDITS_2,
    WM_ATTRACT_DESIGNER_HINT,
    WM_ATTRACT_GENERAL_TIPS,
    WM_ATTRACT_BIO,
    WM_ATTRACT_BIO_TIPS,
    WM_ATTRACT_OPERATOR_MESSAGE,
    WM_ATTRACT_EVEN_LOOP_CREDITS,
    WM_ATTRACT_TIME_DATE,
    WM_ATTRACT_COPYRIGHT,
    WM_ATTRACT_AAMA
} WmAttractScreen;
