...
#define WM_ATTRACT_COPYRIGHT_PAGE2_LINES 10u

/*
 * Text is represented by original source labels instead of invented copy.
 * The merge can resolve labels through the supplied source-text extraction
 * helper or an existing translated text/asset table.
 */
typedef struct {
...
/* General fixed tip table source labels, terminating with NULL. */
extern const char *const wm_attract_general_tip_labels[];

/* Copyright uses two sequential pages of 9 and 10 labels. */
...
#define WM_ATTRACT_BIO_MUG_TABLE_SYMBOL "wrestler_mugs2"
#define WM_ATTRACT_BIO_ATTRIBUTE_TABLE_SYMBOL "wrestler_attributes"
#define WM_ATTRACT_BIO_ATTRIBUTE_BARS_SYMBOL "attbars"
#define WM_ATTRACT_BIO_ATTRIBUTE_LABEL_SYMBOL "ATT_TXT"
#define WM_ATTRACT_BIO_LOGO_Y 24
#define WM_ATTRACT_BIO_LOGO_X 11
#define WM_ATTRACT_BIO_MUG_Y 0x17a
#define WM_ATTRACT_BIO_MUG_X 0
#define WM_ATTRACT_BIO_MUG_Z 0x0af
#define WM_ATTRACT_BIO_ATTRIBUTE_Y 0xff
#define WM_ATTRACT_BIO_ATTRIBUTE_X 0xae
#define WM_ATTRACT_BIO_ATTRIBUTE_BAR_Y (0xff + 61)
#define WM_ATTRACT_BIO_ATTRIBUTE_BAR_X (0xae + 12)
#define WM_ATTRACT_BIO_ATTRIBUTE_BAR_STEP 8
#define WM_ATTRACT_BIO_TEXT_CENTER_X 100
#define WM_ATTRACT_BIO_TEXT_Y 106
#define WM_ATTRACT_BIO_NORMAL_PREWAIT_TSEC 2
#define WM_ATTRACT_BIO_NORMAL_WAIT_TSEC 6
...
#define WM_ATTRACT_GENERAL_TIPS_BACKGROUND_SYMBOL "hstd_mod"
#define WM_ATTRACT_GENERAL_TIPS_TITLE_LABEL "gen_tip_mes"
#define WM_ATTRACT_GENERAL_TIPS_BAR_SYMBOL "MVEBAR_R"
#define WM_ATTRACT_GENERAL_TIPS_SHADOW_SYMBOL "SHADOW01"
#define WM_ATTRACT_GENERAL_TIPS_TITLE_Y 10
#define WM_ATTRACT_GENERAL_TIPS_TITLE_X 200
#define WM_ATTRACT_GENERAL_TIPS_FIRST_Y 60
#define WM_ATTRACT_GENERAL_TIPS_LINE_STEP 15
#define WM_ATTRACT_GENERAL_TIPS_PREWAIT_TSEC 1
#define WM_ATTRACT_GENERAL_TIPS_WAIT_TSEC 10

/* Copyright source presentation. */
#define WM_ATTRACT_COPYRIGHT_FONT_SYMBOL "RD7FONT"
#define WM_ATTRACT_COPYRIGHT_WWF_IMAGE_SYMBOL "SMWWF2"
#define WM_ATTRACT_COPYRIGHT_FIRST_Y 110
#define WM_ATTRACT_COPYRIGHT_X 200
#define WM_ATTRACT_COPYRIGHT_LINE_STEP 12
#define WM_ATTRACT_COPYRIGHT_FADE_STEPS 8
#define WM_ATTRACT_COPYRIGHT_FADE_SETTLE_TICKS 20
#define WM_ATTRACT_COPYRIGHT_PAGE_WAIT_TSEC 3

/* AAMA source presentation. */
#define WM_ATTRACT_AAMA_FONT_SYMBOL "RD7FONT"
#define WM_ATTRACT_AAMA_GRADIENT_ROWS_TOP 31
#define WM_ATTRACT_AAMA_GRADIENT_ROWS_BOTTOM 32
#define WM_ATTRACT_AAMA_FADE_STEPS 8
