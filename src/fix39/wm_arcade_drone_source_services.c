...
int wm_arcade_drone_source_service_dispatch(wm_arcade_actor_t *self,const char *label,void *user){ int id=wm_arcade_drone_source_service_id(label); if(id<0||!wm_fix39_drone_service_handlers[id]) return 0; return wm_fix39_drone_service_handlers[id](self,user) ? 1 : 0; }
