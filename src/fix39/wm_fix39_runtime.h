...
/* Source-backed DRONE callback bundle under incremental binding.  V13e-c1
 * supplies RNDRNG0 plus the exact scalar DRONE.ASM tables; later chunks bind
 * the distinct plain RND service and decoded script/range payloads. */
