...
/*
 * Williams plain RND service used by DRONE.ASM with bit-mask maxima
 * (3, 7, 15, 31). It advances the shared RAND state with the same hardware
 * mix, then returns RAND & mask. This is intentionally distinct from
 * RNDRNG0's multiply-high range scaler.
 */
/*
 * UTIL.ASM RNDPER: input 0..1000, sample 0..999, HI iff probability > sample.
 * This is NOT RNDRNG0(255), and probability 1000 is guaranteed true.
 */
