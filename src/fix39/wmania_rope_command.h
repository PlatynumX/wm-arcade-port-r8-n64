...
typedef enum {
    WM_FIX39_ROPE_FRONT = 0,
    WM_FIX39_ROPE_BACK  = 1,
    WM_FIX39_ROPE_LEFT  = 2,
    WM_FIX39_ROPE_RIGHT = 3
} WmRopeBank;

typedef enum {
    WM_FIX39_ROPE_TOP    = 0,
    WM_FIX39_ROPE_MIDDLE = 1,
    WM_FIX39_ROPE_BOTTOM = 2
} WmRopeStrand;

typedef enum {
    WM_FIX39_ROPE_Z_HIGH = 0,
    WM_FIX39_ROPE_Z_NORM = 1
} WmRopeZAction;

typedef enum {
    WM_FIX39_ROPE_BOUNCE_UD = 0,
    WM_FIX39_ROPE_BOUNCE_IO = 1,
    WM_FIX39_ROPE_SIDE_SPRING = 2,
    WM_FIX39_ROPE_DOWN_SPRING = 3,
    WM_FIX39_ROPE_SIDE_SPRING_RELEASE = 4,
    WM_FIX39_ROPE_DOWN_SPRING_RELEASE = 5,
    WM_FIX39_ROPE_COMMAND_COUNT = 6
} WmRopeAction;

/* Direct ROPES.ASM priorities. */
#define WM_FIX39_ROPE_SIDE_SPRING_PRIORITY 10u
#define WM_FIX39_ROPE_DOWN_SPRING_PRIORITY 9u
#define WM_FIX39_ROPE_SHAKE_PRIORITY 5u

/* ROPES.ASM #LANE_WIDTH = (RING_BOT-RING_TOP)/5 = 64. */
#define WM_FIX39_ROPE_LANE_WIDTH 64

/* set_rope_z hardcoded "high" second-half Z. */
#define WM_FIX39_ROPE_HIGH_SECOND_HALF_Z 0x15a9u
