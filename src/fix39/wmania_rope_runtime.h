...
typedef enum {
    WM_FIX39_ROPE_FRAME_IMAGE = 0,
    WM_FIX39_ROPE_FRAME_GOTO = 1,
    WM_FIX39_ROPE_FRAME_END = 2
} WmRopeFrameKind;
...
typedef enum {
    WM_FIX39_ROPE_SCRIPT_SEQUENCE = 0,
    WM_FIX39_ROPE_SCRIPT_GOTO = 1,
    WM_FIX39_ROPE_SCRIPT_END = 2
...
typedef struct {
    ...
    WmRopeChannelOrder channel[WM_FIX39_ROPE_CHANNEL_COUNT];
...
typedef struct {
    ...
    bool process_alive;
    WmRopeRuntimeChannel channel[WM_FIX39_ROPE_CHANNEL_COUNT];
} WmRopeRuntimeBank;
