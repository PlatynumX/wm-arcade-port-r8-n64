...
typedef enum {
    WM_ROPE_CHANNEL_RED = 0,
    WM_ROPE_CHANNEL_WHITE = 1,
    WM_ROPE_CHANNEL_BLUE = 2,
    WM_ROPE_CHANNEL_SHADOW = 3,
    WM_ROPE_CHANNEL_COUNT = 4
} WmRopeChannel;

typedef enum {
    WM_ROPE_HALF_FIRST = 0,
    WM_ROPE_HALF_SECOND = 1
} WmRopeHalf;
...
typedef struct {
    ...
    WmRopeObjectSeed object[WM_ROPE_CHANNEL_COUNT][2];
} WmRopeBankSeed;
