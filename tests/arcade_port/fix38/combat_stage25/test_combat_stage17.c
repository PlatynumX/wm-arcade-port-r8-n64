...
a.player_mode=WM_PMODE_NORMAL;o.player_mode=WM_PMODE_NORMAL;a.run_time=9;a.facing_dir=WM_MOVE_UP_RIGHT;assert(wm_arcade_yoko_release_charge(&a,&o,85,&c));assert(a.run_time==0&&strcmp(t.anim,"yok_2_salt_anim")==0);
...
rt_reset(&t);c=rt_callbacks(&t);a.facing_dir=WM_MOVE_UP_RIGHT;assert(wm_arcade_yoko_fire_secret(&a,&o,WM_YOKO_SECRET_GUT_PUSH,0,&c));assert(strcmp(t.anim,"yok_2_gut_push_anim")==0);
