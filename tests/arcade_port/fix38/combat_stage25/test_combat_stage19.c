...
a.player_mode=WM_PMODE_NORMAL;o.player_mode=WM_PMODE_NORMAL;a.facing_dir=WM_MOVE_UP_RIGHT;assert(wm_arcade_bam_release_charge(&a,&o,85,&c));assert(strcmp(t.anim,"bam_2_fpunch_anim")==0);
