...
a.player_mode=WM_PMODE_NORMAL;o.player_mode=WM_PMODE_NORMAL;a.facing_dir=WM_MOVE_UP_RIGHT;a.new_facing_dir=WM_MOVE_UP_RIGHT;a.stick_val_cur=0;assert(wm_arcade_doink_release_charge(&a,&o,100,&c));assert(strcmp(t.anim,"dnk_2_buzz_anim")==0);
