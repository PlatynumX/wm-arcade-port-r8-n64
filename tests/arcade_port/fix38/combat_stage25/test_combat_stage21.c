...
a.player_mode=WM_PMODE_NORMAL;o.player_mode=WM_PMODE_NORMAL;a.facing_dir=WM_MOVE_UP_RIGHT;assert(wm_arcade_lex_release_charge(&a,&o,100,&c));assert(strcmp(t.anim,"lex_2_clobber_anim")==0);
...
rt_reset(&t);c=rt_callbacks(&t);a.but_val_down=WM_BTN_PUNCH;a.closest_xdist=20;a.closest_zdist=20;a.facing_dir=WM_MOVE_UP_RIGHT;wm_arcade_move_lex(&a,&o,NULL,&c);assert(strcmp(t.anim,"lex_2_butt_anim")==0);
