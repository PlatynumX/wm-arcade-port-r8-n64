...
# Combat2BY GETUP_TIME recovery: BX ported the wrestler_main countdown tail but
# accidentally omitted GETUP_TIME. Original WRESTLE.ASM's DEBUG stay_down flag
# explicitly documents that normal gameplay decrements GETUP_TIME.
...
'''
if 'Combat2BY GETUP_TIME:' not in t:
    if needle not in t: raise SystemExit('Combat2BY getup countdown anchor missing')
