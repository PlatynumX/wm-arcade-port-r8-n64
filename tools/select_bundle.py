...
CURSOR = ["CRUTPLT_B","CRUTHI_B","CRUTPLT_R","CRUTHI_R"]
...
AWARD_BONUS = [
    "SKILBON",
    "BICON_1A", "BICON_5A", "BICON_10A", "BICON_20A", "BICON_30A",
    "BICON_40A", "BICON_50A", "BICON_60A", "BICON_70A", "BICON_80A",
    "BICON_90A", "BICON_100A",
]
...
# PROGRESS.ASM::INIT_BLOC_TAB exact close-transition WIMP art.
PROGRESS_TRANSITION = [
    "CSELBK_A", "CSELBK_C", "CSELBK_E",
...
REQUIRED = CROUTONS + CURSOR + NAMES + MUGS + DIGITS + FONT9_ALPHA + FONT9_PUNCT + WIN_DIGITS + WSF14_ALPHA + OSGEMD_ALPHA + OSGEMD_PUNCT + AWARD_BONUS + BUYIN + BELT_CHOICE + PROGRESS_UI + PROGRESS_TRANSITION + PROGRESS_EFFECTS + PROGRESS_PARTICLES
